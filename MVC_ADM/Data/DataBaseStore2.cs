...
using MVC_ADM.Models;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product() { ProductId = 7, ProductName = "Vaso Vitória", Price = 6, Amount = 1, Description = "Vaso de cerâmica vitória de qualidade superior indicado para plantas de interior.", CategoryId = 3, ImgFotoProduct = "/images/images/vasovitoria.png" },
